...
import { FormBodyData, PostFormBodyData } from '@/types/contact'

type SendMailProps = Omit<PostFormBodyData, 'token'>
...
export const sendMail = async ({
  ...
  const from = `"WEBSITE" <${gmail}>`
  const to = gmail
  const subject = 'WEBSITEよりお問い合わせがありました'
